...
#' \item{RE2Cp: }{RE2 p-value account for correlelation between tests}
#' \item{RE2Cp.twoStep: }{two step RE2C test after fixed effect test.  Only evaluated if twoStep==TRUE}
